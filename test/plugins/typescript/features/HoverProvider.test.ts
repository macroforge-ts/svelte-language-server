...
describe('HoverProvider', function () {
    ...
    it('provides basic hover info when no docstring exists', async () => {
        ...
        assert.deepStrictEqual(
            await provider.doHover(document, Position.create(6, 10)),
            <Hover> {
    ...
    it('provides formatted hover info when a docstring exists', async () => {
        ...
        assert.deepStrictEqual(
            await provider.doHover(document, Position.create(4, 10)),
            <Hover> {
    ...
    it('provides formatted hover info for component events', async () => {
        ...
        assert.deepStrictEqual(
            await provider.doHover(document, Position.create(12, 26)),
            <Hover> {
                contents:
    ...
    it('provides formatted hover info for jsDoc tags', async () => {
        ...
        assert.deepStrictEqual(
            await provider.doHover(document, Position.create(9, 10)),
            <Hover> {
    ...
    it('provides hover info for $store access', async () => {
        ...
        assert.deepStrictEqual(
            await provider.doHover(document, Position.create(3, 5)),
            <Hover> {
                contents: '```typescript\nlet $b: string | {\n    a: boolean | string;\n}\n```',
                range: {
                    end: {
        ...
        assert.deepStrictEqual(
            await provider.doHover(document, Position.create(5, 9)),
            <Hover> {
                contents: '```typescript\nlet $b: string\n```',
                range: {
                    end: {
        ...
        assert.deepStrictEqual(
            await provider.doHover(document, Position.create(7, 4)),
            <Hover> {
                contents:
        ...
        assert.deepStrictEqual(
            await provider.doHover(document, Position.create(10, 2)),
            <Hover> {
                contents: '```typescript\nlet $b: string | {\n    a: boolean | string;\n}\n```',
                range: {
                    end: {
        ...
        assert.deepStrictEqual(
            await provider.doHover(document, Position.create(12, 6)),
            <Hover> {
                contents: '```typescript\nlet $b: string\n```',
                range: {
                    end: {
        ...
        assert.deepStrictEqual(
            await provider.doHover(document, Position.create(14, 1)),
            <Hover> {
                contents:
                    '```typescript\nconst b: Writable<string | {\n    a: boolean | string;\n}>\n```',
                range: {
