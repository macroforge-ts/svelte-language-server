...
export class RenameProviderImpl implements RenameProvider {
    ...
    async rename(
        ...
        let convertedRenameLocations: TsRenameLocation[] = await this
            .mapAndFilterRenameLocations(
                renameLocations,
                docs,
        ...
        const additionalRenameForPropRenameInsideComponentWithProp = await this
    ...
    private async getAdditionLocationsForRenameOfPropInsideComponentWithProp(
        ...
        return renameLocations.map((location) => {
            ...
            const shorthandLocation = this.transformShorthand(
                snapshot,
                location,
                newName
            );
    ...
    private async getAdditionalLocationsForRenameOfPropInsideOtherComponent(
        ...
        const replacementsForProp = lang.findRenameLocations(
            updatePropLocation.fileName,
            idx,
            false,
            false
    ...
    private transformShorthand(
        ...
        const shorthand = this.getBindingOrAttrShorthand(
            snapshot,
